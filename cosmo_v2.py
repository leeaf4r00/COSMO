...
layout = [
    ...
    [sg.Text("Insira o código de barras do produto:" if values["-EAN-"]
             else "Insira a descrição do produto:"), sg.Input(key="-SEARCH-")],
...
while True:
    ...
    if values["-EAN-"]:
        search_type = "gtins"
        search_prompt = "Insira o código de barras do produto:"
    else:
        search_type = "products"
        search_prompt = "Insira a descrição do produto:"

    window.Element("-SEARCH-").Update(search_prompt)
